...
window.TRANSLATIONS = {
  English: {
    ...
    quickGuideBtn: '📖 Quick Guide',
    // Tour step translations (English)
    tourBadge1: 'Step 1 of 6 • Point & Scan',
    tourTitle1: '1. Point Camera at Anything',
    tourDesc1: 'Tap the giant blue camera shutter or upload any photo. CareLens easily reads medicine bottles, paper utility bills, letters, notices, food labels, and appliance dials.',
    tourTip1: '💡 Testing without a physical item? Use the "Sample Images" on the home screen!',
    tourBadge2: 'Step 2 of 6 • Senior Audio',
    tourTitle2: '2. Clear Voice & Plain Summaries',
    tourDesc2: 'CareLens gives a 2-sentence plain language summary and speaks it aloud at a calm, 0.88x gentle pace. Perfect for tired eyes or hearing assistance.',
    tourTip2: '💡 You can pause or replay the voice audio anytime with the "Read Aloud" button.',
    tourBadge3: 'Step 3 of 6 • Scam Protection',
    tourTitle3: '3. Three-Tier Trust & Scam Shield',
    tourDesc3: 'Every document is verified: 🟢 Green for Verified Safe, 🟡 Yellow for Caution, and 🚨 Red for Dangerous Scams. Never get tricked by fake notices.',
    tourTip3: '💡 If flagged red, do not call phone numbers or scan QR codes listed on the document.',
    tourBadge4: 'Step 4 of 6 • Voice Q&A',
    tourTitle4: '4. Ask Any Follow-up Question',
    tourDesc4: 'Got a question? Tap the microphone 🎤 or type: "When should I take this pill?" CareLens answers directly from the scanned document.',
    tourTip4: '💡 Voice answers can also be read aloud in your chosen language with 1 tap.',
    tourBadge5: 'Step 5 of 6 • Family Bridge',
    tourTitle5: '5. 1-Tap Second Opinion on WhatsApp',
    tourDesc5: 'Need your daughter, son, or caregiver to double check? Tap one button to share the simplified summary and safety verdict directly to their WhatsApp.',
    tourTip5: '💡 Set your family\'s WhatsApp number using the 💬 WhatsApp button in the top bar.',
    tourBadge6: 'Step 6 of 6 • Accessibility',
    tourTitle6: '6. Text Magnifier, 13 Languages & Dark Mode',
    tourDesc6: 'Use the top toolbar anytime to magnify text (🔍), switch between 13 regional Indian and global languages, or switch to Midnight Slate dark mode (🌙).',
    tourTip6: '💡 You can reopen this Quick Guide anytime by clicking the 📖 Quick Guide button in the top bar!'
  },
  Hindi: {
